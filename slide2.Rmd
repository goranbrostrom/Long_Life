...
uk <- read.table("data/IDL/uk.csv", header = TRUE, sep = ";")
japan <- read.table("data/IDL/japan.csv", header = TRUE, sep = ";")
france <- read.table("data/IDL/france.csv", header = TRUE, sep = ";")
